...
# print, input, list, sorted, sum, len, abs, insinstance, type
...
# enumerate - нумерует последоватьельность (по умолчанию с 0)

# map - принимает функцию и последовательность (записывает в новую последовательность функции)

# filter - принимает функцию и последовательность, фильтрирует по тому что возвращает функция (если True - оставляет. если False - убирает)
...
# Домашняя задание all any sorted 



# from functools import reduce  - метод импорта с библиотек № 1

#import functools
#functools.reduce() - метод импорта с библиотеки №2

# Хеширование
#Hash map in Python 
#Collision Коллизия хеш-функции
